...
export default function Login() {
  ...
  return (
    <Center className="auth-workspace" style={{ minHeight: '100svh', paddingTop: 16, paddingBottom: isMobile ? 72 : 16, position: 'relative' }}>
      <Box className="auth-panel" p="xl" w={500}>
        <Stack gap="lg">
