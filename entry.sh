...
window.__APP_CONFIG__ = {
  ...
  ALLOW_SERVICE_BLOCKED: "${ALLOW_SERVICE_BLOCKED:-false}",
  ...
  MONO_SERVICE_ENABLE: "${MONO_SERVICE_ENABLE:-false}",
  MONO_SERVICE_CATEGORIES: "${MONO_SERVICE_CATEGORIES:-}",
  MONO_SERVICE_STATUSES: "${MONO_SERVICE_STATUSES:-ACTIVE,NOT PAID,PROGRESS,BLOCK}",
  SHOW_CARD_QUICK_ACTIONS: "${SHOW_CARD_QUICK_ACTIONS:-true}",
  NAV_PAYMENTS_IN_PROFILE: "${NAV_PAYMENTS_IN_PROFILE:-false}",
  THEME_GLASSMORPHISM_ENABLE: "${THEME_GLASSMORPHISM_ENABLE:-false}",
  DASHBOARD_PAGE_ENABLE: "${DASHBOARD_PAGE_ENABLE:-false}",
  ORDER_GROUP_BY_PERIOD: "${ORDER_GROUP_BY_PERIOD:-true}",
  CONFIGURE_BUTTON_LABEL: "${CONFIGURE_BUTTON_LABEL:-}",
  CUSTOM_INSTRUCTION: "${CUSTOM_INSTRUCTION:-}",
  SHOW_TARIFF_DESCRIPTION: "${SHOW_TARIFF_DESCRIPTION:-true}"
};
EOF
